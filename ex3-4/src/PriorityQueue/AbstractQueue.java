...
public interface AbstractQueue<E> {
    ...
    public E top() throws PriorityQueueException; // accede all'elemento in cima alla coda -- O(1)
    public void pop()throws PriorityQueueException; // rimuove l'elemento in cima alla coda -- O(logN)
